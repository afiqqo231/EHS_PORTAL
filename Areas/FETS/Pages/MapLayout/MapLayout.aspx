<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MapLayout.aspx.cs"
Inherits="FETS.Pages.MapLayout.MapLayout"
      ...
      <div class="upload-section">
        ...
        <div class="form-group">
          <asp:Label
            ...
            runat="server"
            Text="Map Image:"
            AssociatedControlID="fuMapImage"
          ></asp:Label>
          ...
          <div class="filter-row">
            <div class="filter-group">
              <asp:Label
                ...
                runat="server"
                Text="Plant:"
                AssociatedControlID="ddlFilterPlant"
              ></asp:Label>
              <asp:DropDownList
                ID="ddlFilterPlant"
                runat="server"
            ...
            <div class="filter-group">
              <asp:Label
                ...
                runat="server"
                Text="Level:"
                AssociatedControlID="ddlFilterLevel"
              ></asp:Label>
              <asp:DropDownList
                ID="ddlFilterLevel"
                runat="server"
                CssClass="form-control"
                AutoPostBack="true"
                OnSelectedIndexChanged="ddlFilterLevel_SelectedIndexChanged"
              ></asp:DropDownList>
            </div>
          </div>
        </div>
              ...
              <asp:TemplateField HeaderText="Preview">
                <ItemTemplate>
                  <asp:Image
                    ID="imgPreview"
                    runat="server"
                    ImageUrl='<%# GetMapImageUrl(Eval("ImagePath").ToString()) %>'
                ...
                <ItemTemplate>
                  <div class="action-buttons">
                    <button
                      ...
                      onclick="openMapFromButton(this)"
                    >
                      View
                    </button>
                    <asp:LinkButton
  ...
  >
    ...
    >
      ...
      >
        <span
          id="editSaveStatus"
          style="font-size: 0.85rem; margin-right: 10px"
        ></span>
        <button
          type="button"
          onclick="closeEditModal()"
